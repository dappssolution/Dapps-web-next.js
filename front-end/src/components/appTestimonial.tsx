        ...
        <div className="relative">
          ...
          <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8 md:mb-10 lg:mb-12">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-600">CEO, Khibra App</p>
            </div>
          </div>
          ...
          <div className="pr-8 sm:pr-12 md:pr-16 lg:pr-24">
            ...
            They built a secure and intuitive legal consultation app, showing high-quality execution.             </blockquote>
          </div>
        </div>
      </div>
    )
