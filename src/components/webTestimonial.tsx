...
export default function WebTestimonial() {
    return (
      <div className="max-w-6xl mx-auto pt-12 p-4 sm:p-6 md:p-8 lg:p-12 xl:p-16">
        <div className="relative">
          ...
          <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8 md:mb-10 lg:mb-12">
            ...
            <div>
              <h3 className="font-semibold text-base sm:text-lg text-gray-900">Sahal</h3>
          ...
          <div className="pr-8 sm:pr-12 md:pr-16 lg:pr-24">
            ...
            They delivered a clean, fast, and user-friendly website that made a real difference for our business.            </blockquote>
          </div>
        </div>
      </div>
    )
