...
export default function AppResultSection() {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-12 gap-8 md:gap-12 items-center">
          <div className={`md:col-span-8 space-y-4 sm:space-y-6 result-content ${language === 'ar' ? 'text-right' : ''}`}>
            ...
            We craft high-performance apps that captivate users, earn trust, and fuel business growth — powered by cutting-edge front-end and full-stack expertise.          </p>
          </div>
