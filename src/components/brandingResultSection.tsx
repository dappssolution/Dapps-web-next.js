...
export default function BrandingResultSection() {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-12 gap-8 md:gap-12 items-center">
          <div className={`md:col-span-8 space-y-4 sm:space-y-6 result-content ${language === 'ar' ? 'text-right' : ''}`}>
            ...
            We deliver brand identities that inspire connection and trust, helping businesses stand out and resonate with their communities.            </p>
          </div>
