...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  const translations: Translations = {
    en: {
      ...
      'footer.phone': 'Phone:',
      'footer.phoneQatar': '+974 7747 3725',
      'footer.phoneDubai1': '+971 54 254 5909',
      'footer.phoneDubai2': '+971 54 487 8929',
      'footer.phoneIndia': '+91 99474 00278',
      'footer.locations': 'Our Locations',
      'footer.locationDubai': 'Dubai, United Arab Emirates',
      'footer.locationCalicut': 'Calicut, India',
      'footer.locationQatar': 'Doha, Qatar',
    ...
    ar: {
      ...
      'footer.email': 'info@dappssolutions.com',
      'footer.phone': 'الهاتف:',
      'footer.phoneQatar': '+٩٧٤ ٧٧٤٧ ٣٧٢٥',
      'footer.phoneDubai1': '+٩٧١ ٥٤ ٢٥٤ ٥٩٠٩',
      'footer.phoneDubai2': '+٩٧١ ٥٤ ٤٨٧ ٨٩٢٩',
      'footer.phoneIndia': '+٩١ ٩٩٤٧٤ ٠٠٢٧٨',
      'footer.locations': 'مواقعنا',
      'footer.locationDubai': 'دبي، الإمارات العربية المتحدة',
      'footer.locationCalicut': 'كاليكوت، الهند',
      'footer.locationQatar': 'الدوحة، قطر',
